...
- Changed Newbro browser STT so the Home shell starts a muted realtime STT session, while Bro detail owns microphone unmute and routes final ASR turns to the selected Bro.
