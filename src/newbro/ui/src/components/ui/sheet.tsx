  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right" &&
          "inset-y-0 right-0 h-full w-[90vw] border-l border-border/60 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-xl",
        side === "left" &&
          "inset-y-0 left-0 h-full w-[90vw] border-r border-border/60 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-xl",
        className,
      )}
      {...props}
    >
