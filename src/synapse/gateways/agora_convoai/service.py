...
AGORA_CONVOAI_IMPLEMENTATION_VERSION = "agora-convoai-gateway.v1"
...
class PreparedConvoAISession:
    ...
    diagnostics: GatewaySessionDiagnostics | None = None
...
class AgoraSDKConvoAIService:
    def __init__(self, settings: AgoraConvoAIGatewaySettings) -> None:
        ...
        *,
        ...
        try:
            ...
            raise ConvoAIConfigurationError(
                f"Unsupported SYNAPSE_GATEWAY_AGORA_CONVOAI_AREA: {self._settings.convoai_area}"
            ) from exc
        ...
        *,
        ...
        try:
            ...
            raise ConvoAIRuntimeError(
                ...
                "Check network access or try another SYNAPSE_GATEWAY_AGORA_CONVOAI_AREA."
            ) from exc
