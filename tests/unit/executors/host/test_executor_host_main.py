...
from synapse.executors.host.config import ExecutorHostSettings, LoadedExecutorHostConfig

executor_host_main = importlib.import_module("synapse.executors.host.__main__")
