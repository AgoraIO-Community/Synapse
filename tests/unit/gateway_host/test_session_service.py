...
from synapse.gateways.base import GatewayBindingRegistry
from synapse.gateways.agora_convoai.models import GatewaySessionDiagnostics, GatewaySessionPrepareRequest
from synapse.gateways.agora_convoai.service import PreparedConvoAISession
from synapse.gateways.agora_convoai.session_service import AgoraGatewaySessionService
...
async def test_prepare_session_preserves_empty_string_instruction_overrides():
    ...
    session_service = AgoraGatewaySessionService(
        GatewayBindingRegistry(_FakeTransport(), _FakeSpeaker()),
